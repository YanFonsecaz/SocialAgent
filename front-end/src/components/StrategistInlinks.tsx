...
export function StrategistInlinks() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const details = stringifyMaybeErrorDetails(err as ErrorWithDetails);
                        ...
                        >
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-xs text-gray-400 mb-2">
                                    Cole todas as URLs de uma vez, uma por linha
                                    (máx. 100).
                                </p>
                                <textarea
                                    id="analysis-urls"
                    ...
                    <div className="mt-auto">
                        <div className="p-4 bg-orange-50 rounded-lg border border-orange-100">
                            ...
                            <p className="text-xs text-orange-700 leading-relaxed">
                                Informe a URL principal (destino dos links) e as
                                URLs satélites. A IA analisará cada satélite para
                                encontrar oportunidades de linking interno,
                                sugerindo âncoras e frases.
                            </p>
                        </div>
                    </div>
                </aside>
                        ...
                        {!result && !isLoading && !error && (
                            <div className="flex flex-col items-center justify-center h-full text-center text-gray-400 p-8">
                                ...
                                <p className="max-w-md mx-auto">
                                    Identifique oportunidades de linking interno.
                                    Insira uma URL principal e as URLs satélites
                                ...
                                {result.selecionadas.length === 0 &&
                                    result.rejeitadas.length === 0 && (
                                        <div className="bg-white rounded-xl border border-gray-100 p-8 shadow-sm text-center">
                                            <p className="text-sm text-gray-500">
                                                Nenhuma oportunidade de inlink foi
                                                identificada.
                                            </p>
                                        </div>
                                    )}
